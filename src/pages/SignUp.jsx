        ...
        <div className="min-h-screen bg-[#F9FAFB] flex items-center justify-center p-2 sm:p-4 lg:p-6">
            ...
            <div className="relative w-full max-w-[1100px] bg-white rounded-2xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] flex flex-col md:flex-row overflow-hidden">
                ...
                <main className="flex-1 flex flex-col justify-center p-4 sm:p-6 md:p-8 lg:p-10 relative">
                    ...
                    <div className="w-full max-w-[390px] mx-auto flex flex-col gap-3 sm:gap-4">
                        ...
                        {error && (
                            <div
                                role="alert"
                                className="flex items-start gap-2.5 bg-red-50 border border-red-200 text-red-700 text-sm rounded-lg px-3 py-2.5"
                            >
                        ...
                        <p className="text-center text-xs sm:text-sm text-[#4A5565]">

    ...
    return (
        ...
        >
            ...
            <div
                ...
                className="relative w-full max-w-[440px] max-h-[calc(100vh-1.5rem)] overflow-y-auto rounded-2xl bg-white shadow-[0_32px_64px_-12px_rgba(0,0,0,0.35)] animate-[modalIn_0.2s_ease-out]"
            >
                {/* Close button */}
                <button
                    type="button"
                ...
                <div className="flex flex-col items-center gap-4 sm:gap-5 px-5 pt-8 pb-6 sm:px-8 sm:pt-10 sm:pb-8">
                    {/* Decorative icon */}
                    <div
                        aria-hidden="true"

  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Description list -each stat is a (term, definition) pair, the correct semantic markup for a stats grid */}
        <dl className="grid grid-cols-2 gap-y-8 gap-x-4 md:grid-cols-4 md:gap-4 lg:gap-6">
          {STATS.map((stat) => (
            <div
              key={stat.label}
